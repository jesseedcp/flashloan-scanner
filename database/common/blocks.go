...
import (
	...
	common2 "github.com/cpchain-network/flashloan-scanner/database/utils"
)
...
type BlocksView interface {
	...
	ChainBlockHeaderByNumber(chainId string, number *big.Int) (*BlockHeader, error)
...
func (b blocksDB) ChainBlockHeaderByNumber(chainId string, number *big.Int) (*BlockHeader, error) {
	return b.ChainBlockHeaderWithFilter(chainId, BlockHeader{Number: number})
}
