...
import (
	...
	"github.com/cpchain-network/flashloan-scanner/database/common"
	"github.com/cpchain-network/flashloan-scanner/database/event"
	dbscanner "github.com/cpchain-network/flashloan-scanner/database/scanner"
	"github.com/cpchain-network/flashloan-scanner/database/utils"
	_ "github.com/cpchain-network/flashloan-scanner/database/utils/serializers"
)
...
type DB struct {
	...
	ProtocolAddress     dbscanner.ProtocolAddressDB
	UniswapV2Pair       dbscanner.UniswapV2PairDB
	ObservedTx          dbscanner.ObservedTransactionDB
...
func NewDB(ctx context.Context, dbConfig config.Database) (*DB, error) {
	...
	db := &DB{
		...
		ProtocolAddress:     dbscanner.NewProtocolAddressDB(gorm),
		UniswapV2Pair:       dbscanner.NewUniswapV2PairDB(gorm),
		ObservedTx:          dbscanner.NewObservedTransactionDB(gorm),
